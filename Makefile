...
mock:
	mockgen -package mockdb --destination db/mock/store.go github.com/nemanjaj/simplebank/db/sqlc Store 

.PHONY: postgres createdb dropdb migrateup migratedown sqlc sqlcl server mock migrateup1 migratedown1